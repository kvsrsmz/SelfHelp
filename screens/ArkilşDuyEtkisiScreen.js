    ...
    <View style={styles.container}>
      ...
      <View style={styles.top}>
          ...
          <View style={styles.box}>
            <View className="flex-row"style={{marginBottom:-30,marginHorizontal:5}}>
              ...
              <Text style={{marginTop:30,fontSize:20,color:"white",marginHorizontal:5,marginLeft:9}}>Arkadaşlık İlişkilerinin Duygular Üzerindeki Etkisi</Text>
            </View>
            <Svg 
              height={90}
              marginLeft= {0.4}
      ...
      <View style={styles.imageGolge}>
            <Image source={require('../assets/images/arkadaslik.jpg')} 
              style={{width:260,height:200,marginHorizontal:10,marginTop:3,marginBottom:60,
              borderTopLeftRadius: 20, borderTopRightRadius: 20,borderBottomLeftRadius:20,borderBottomRightRadius:20,}}/>
                
          </View>

          <Text  style={{color:"black", fontSize:15,paddingTop:25,marginHorizontal:50,lineHeight:22,marginBottom:100,}}>
