...
export default function AnaSayfaScreen() {
      ...
      <View style={styles.top}>
          ...
          <View style={styles.box}>
            <View className="flex-row"style={{marginBottom:-30}}>
              ...
              <Text style={{marginTop:37,fontSize:22,color:"white",marginHorizontal:5}}>Güncel Yazılar</Text>
            </View>
            <Svg 
              height={90}
              marginLeft= {0.4}
      ...
      <TouchableOpacity onPress={()=> navigation.navigate('ArkilşDuyEtkisi')}>
          <View style={styles.imageGolge2}>
            <Image source={require('../assets/images/güncelYazilar.jpg')} 
              style={{width:160,height:110,marginHorizontal:9,marginTop:6,
              borderTopLeftRadius: 20, borderTopRightRadius: 20,borderBottomLeftRadius:20,borderBottomRightRadius:20,}}/>
                <View style={styles.textBox2}>
                <HeartButton3 />
                  <Text style={{fontSize:12,justifyContent:"center",color:"white",marginHorizontal:10,marginBottom:-15,marginTop:-30}}>Arkadaşlık İlişkilerinin Duygular Üzerindeki Etkisi</Text>
                </View>     
          </View>
          </TouchableOpacity>
          ...
          <View style={styles.imageGolge2}>
            <Image source={require('../assets/images/güncelYazilar.jpg')} 
              ...
              borderTopLeftRadius: 20, borderTopRightRadius: 20,borderBottomLeftRadius:20,borderBottomRightRadius:20,}}/>
                <View style={styles.textBox2}>
                <HeartButton3 />
                  <Text style={{fontSize:12,justifyContent:"center",color:"white",marginHorizontal:10,marginBottom:-15,marginTop:-30
                  }}>Arkadaşlık İlişkilerinin Duygular Üzerindeki Etkisi</Text>
                </View>     
          </View>
          </TouchableOpacity>
          </View>
  ...
  {/*RUHSAL BUNALIMLAR*/}  
  <View className="flex-row" style={{marginTop:-120}}>
