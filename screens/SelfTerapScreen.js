...
export default function AnaSayfaScreen() {
      ...
      <View style={styles.top}>
          ...
          <View style={styles.box}>
            <View className="flex-row"style={{marginBottom:-30}}>
              ...
              <Text style={{marginTop:37,fontSize:22,color:"white",marginHorizontal:5}}>SELF TERAPİLER</Text>
            </View>
            <Svg 
              height={90}
              marginLeft= {0.4}
  ...
  {/*İLİŞKİLER*/}
      <Text style={{marginTop:50,marginHorizontal:40,fontSize:17}}>İlişkiler</Text> 
        <View className="flex-row" style={{marginTop:-90}} >
          ...
          <TouchableOpacity onPress={()=> navigation.navigate('SelfTerapiler')}>
            <Image source={require('../assets/images/arkadaslik.jpg')} 
              style={{width:140,height:180,marginHorizontal:10,marginTop:6,
              borderTopLeftRadius: 20, borderTopRightRadius: 20,borderBottomLeftRadius:20,borderBottomRightRadius:20,}}/>
                <View style={styles.textBox}>
        ...
        <View className="flex-row" style={{marginTop:-90}} >
          ...
          <TouchableOpacity onPress={()=> navigation.navigate('SelfTerapiler')}>
            <Image source={require('../assets/images/arkadaslik.jpg')} 
              ...
              borderTopLeftRadius: 20, borderTopRightRadius: 20,borderBottomLeftRadius:20,borderBottomRightRadius:20,}}/>
                <View style={styles.textBox}>
                  <Text style={{fontSize:12,justifyContent:"center"}}>Romantik İlişkiler</Text>
                </View>
                </TouchableOpacity>
          </View>
          ...
          <TouchableOpacity onPress={()=> navigation.navigate('SelfTerapiler')}>
            <Image source={require('../assets/images/arkadaslik.jpg')} 
              ...
              borderTopLeftRadius: 20, borderTopRightRadius: 20,borderBottomLeftRadius:20,borderBottomRightRadius:20,}}/>
                ...
                <View style={styles.textBox}>
                  <Text style={{fontSize:12,justifyContent:"center"}}>Mesleki İlişkiler</Text>
                </View>
                </TouchableOpacity>
          </View>
  ...
  {/*LOREM İPSUM*/}  
        <Text style={{marginTop:30,marginHorizontal:40,fontSize:17}}>Lorem ipsum</Text> 
        <View className="flex-row" style={{marginTop:-90}} >
          <View style={styles.imageGolge}>
          <TouchableOpacity onPress={()=> navigation.navigate('SelfTerapiler')}>
            <Image source={require('../assets/images/arkadaslik.jpg')} 
              ...
              borderTopLeftRadius: 20, borderTopRightRadius: 20,borderBottomLeftRadius:20,borderBottomRightRadius:20,}}/>
                <View style={styles.textBox}>
                  <Text style={{fontSize:12,justifyContent:"center"}}>Lorem ipsum</Text>
                </View>
        </TouchableOpacity>     
          </View>
          <View style={styles.imageGolge}>
